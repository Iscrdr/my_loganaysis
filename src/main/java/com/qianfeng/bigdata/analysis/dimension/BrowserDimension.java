...
public class BrowserDimension extends BaseDimension {
    ...
    public String getBrowserName() {
        return  StringUtils.isBlank(browserName)? GlobalConstants.DEFAULT_VALUE:browserName;
    }
    ...
    public String getBrowserVersion() {
        return StringUtils.isBlank(browserVersion)? GlobalConstants.DEFAULT_VALUE:browserVersion;
    }
